...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      axios.get('/admin/getSpotByPage?currPage=' + data.currPage).then((res) => {
    ...
    const handleDelete = (index, row) => {
      ...
      axios.get('/admin/deleteSpotByID?sid=' + row.sid).then((res) => {
        if (res.data === 'ok') {
          alert('删除成功！')
          //********刷新页面********************************* */
          axios.get('/admin/getSpotByPage?currPage=' + data.currPage).then((res) => {
    ...
    const handMultiDelete = () => {
      axios.post('/admin/deleteSpotMulti', data.SpotMulti).then((res) => {
        if (res.data === 'ok') {
          alert('删除成功！')
          //********刷新页面********************************* */
          axios.get('/admin/getSpotByPage?currPage=' + data.currPage).then((res) => {
