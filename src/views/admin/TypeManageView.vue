...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      axios
        .get("/admin/getTypeByPage?currPage=" + data.currPage)
        .then((res) => {
   ...
   //设置序号
    ...
    const handleDelete=(index,row) => {
      ...
      axios.get("/admin/deleteTypeByID?Typeid="+row.Typeid)
      .then(res=>{
        if(res.data==="ok"){
          alert("删除成功！");
        //********刷新页面********************************* */
          axios.get("/admin/getTypeByPage?currPage=" + data.currPage)
        .then((res) => {
          data.TypeList = res.data.TypeList;
          data.hasNext = res.data.hasNext;
        });
    ...
    const handMultiDelete=() => {
      axios.post("/admin/deleteTypeMulti",data.TypeMulti)
      .then(res =>{
        if(res.data==="ok"){
          alert("删除成功！");
        //********刷新页面********************************* */
